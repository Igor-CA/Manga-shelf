		...
		<div className="page-content">
			<div className="container">
				<article className="about-page">
					...
					<p>
						O Manga Shelf nasceu da necessidade de uma alternativa mais prática
						e intuitiva para organizar coleções de mangás, sem depender de
						planilhas ou anotações manuais.
					</p>
					<p>
						Embora existam plataformas similares, como MyAnimeList e Anilist,
						nenhuma atendia totalmente às nossas necessidades. Queríamos um
						sistema que permitisse marcar volumes individualmente, reconhecendo
						diferentes edições de uma mesma obra.
					</p>
					<p>
						Foi assim que surgiu o Manga Shelf, uma plataforma dedicada
						exclusivamente a mangás lançados <strong>fisicamente</strong> no
						Brasil. Nosso objetivo é oferecer uma solução eficiente para
						colecionadores e fãs do formato.
					</p>
					<p>
						Hoje, disponibilizamos esse projeto com a esperança de que seja útil
					...
					<ul>
						...
						<li>
							...
							autoria, tamanho e obras relacionadas
						</li>
					...
					<p>
						Para lançar o Manga Shelf mais rapidamente, algumas funcionalidades
						foram adiadas, mas já temos planejadas algumas ideias para as
					...
					<p>
						Os dados utilizados no Manga Shelf, como imagens, sinopses e
						gêneros, foram coletados diretamente dos sites das editoras ou de
