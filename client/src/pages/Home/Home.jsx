import { faBook, faCheck, faList, faMagnifyingGlass } from "@fortawesome/free-solid-svg-icons";
                ...
                <div className="home__features-container">
                    <div className="home__feature">
                        ...
                        <div>
                                        ...
                                        <p className="feature__description">
                                            Adicione mangás à sua prateleira e mantenha-se atualizado sobre o
                    ...
                    <div className="home__feature">
                        ...
                        <div>
                                        ...
                                        <p className="feature__description">Mantenha o controle sobre os volumes que você já possui. Marque os volumes que estão em suas mãos, acompanhe edições especiais e saiba instantaneamente quais estão faltando</p>
                                    </div>
                    </div>
                    <div className="home__feature">
                        <div className="home__icon__container">
                        ...
                        <div>
                                        <h3 className="feature__title">Volumes faltando:</h3>
                                        <p className="feature__description">
                    ...
                    <div className="home__feature">
                        <div className="home__icon__container">
                                        <FontAwesomeIcon className="home__icon" icon={faMagnifyingGlass} />
                                    </div>
                        <div>
                                        <h3 className="feature__title">Explore titulos:</h3>
                                        <p className="feature__description">
                                            Encontre diferentes obras e obtenha detalhes como autores, editora,
                                            formato, sinopse e preço de cada volume.
                                        </p>
                                    </div>
                    </div>
                </div>
